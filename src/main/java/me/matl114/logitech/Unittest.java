...
public class Unittest {
    ...
    // todo
    // a possibility to handle vanilla block in MultiBlock structures ,maybe we need more listeners and fix the
    // getStatus and getUUID method in MultiBlockService
