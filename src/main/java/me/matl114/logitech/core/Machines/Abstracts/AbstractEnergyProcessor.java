...
public abstract class AbstractEnergyProcessor extends AbstractEnergyProvider
        implements MachineProcessHolder<EnergyProviderOperation> {
    ...
    public AbstractEnergyProcessor(
            ItemGroup category,
        ...
        if (inv != null && conditionHandle(null, inv)) {
            ...
            if (currentOperation == null) {
                ...
                if (nextP != null) {
                    ...
                    if (next.getTicks() > 0) {
                        currentOperation =
                                new EnergyProviderOperation(outputInfo, next.getTicks(), this.energyConsumption);
