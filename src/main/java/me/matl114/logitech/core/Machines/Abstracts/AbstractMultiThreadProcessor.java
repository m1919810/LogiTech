...
public class AbstractMultiThreadProcessor extends AbstractMachine
        implements MachineProcessHolder<SimpleCraftingOperation> {
    protected final int[] BORDER_IN = new int[] {0, 1, 2, 3, 4, 5, 6, 7, 8};
    protected final int[] BORDER_OUT = new int[] {36, 37, 38, 39, 40, 41, 42, 43, 44};
    ...
    protected final int[] PROCESSOR_SLOT = new int[] {18, 19, 20, 21, 22, 23, 24, 25, 26};
    ...
    public AbstractMultiThreadProcessor(
            ItemGroup category,
