...
public abstract class AdvancedSpecialCrafter extends AbstractProcessor implements RecipeLock, ImportRecipes {
    ...
    protected final int[] BORDER = {3, 5, 12, 14};
    ...
    public boolean parseRecipe(BlockMenu menu) {
        ...
        if (providedRecipesMap == null) return false;
    ...
    public void process(Block b, BlockMenu inv, SlimefunBlockData data) {
        ...
        if (currentOperation == null) {
            ...
            Pair<ItemConsumer[], ItemConsumer[]> nextP =
                    CraftUtils.countOneRecipe(inv, getInputSlots(), getOutputSlots(), next, CRAFT_PROVIDER);
