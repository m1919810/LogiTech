...
public class SMGenerator extends AbstractTransformer {
    ...
    private final int[] BORDER = new int[] {9, 18, 27, 36, 45};
    private final int[] OUTPUT_BORDER = {};
    private final int[] INPUT_SLOT = {};
    private final int[] OUTPUT_SLOTS = {
        1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13, 14, 15, 16, 17, 19, 20, 21, 22, 23, 24, 25, 26, 28, 29, 30, 31, 32, 33,
        34, 35, 37, 38, 39, 40, 41, 42, 43, 44, 46, 47, 48, 49, 50, 51, 52, 53
    };
    ...
    public SMGenerator(
        ...
        super(itemGroup, item, recipeType, recipe, time, energybuffer, energyConsumption, new PairList<>() {
            {
                this.put(new Pair<>(new ItemStack[] {}, outputs_w), time - 1);
            }
        });
