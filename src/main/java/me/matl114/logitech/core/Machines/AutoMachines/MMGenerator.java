...
public class MMGenerator extends AbstractTransformer {
    protected final int[] BORDER = new int[] {0, 1, 2, 6, 7, 8};
    protected final int[] BORDER_IN = new int[] {3, 5};
    protected final int[] BORDER_OUT = new int[] {9, 10, 11, 12, 14, 15, 16, 17};
    protected final int[] INPUT_SLOT = new int[] {4};
    ...
    public MMGenerator(
            ...
            List<Pair<Object[], Object[]>> outputs_w) {
