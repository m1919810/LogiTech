...
//    }
    ...
    public static final MyVanillaItem MACE_ITEM=new InitializeSafeProvider <>(MyVanillaItem.class, ()->{
        if(AddItem.MACE_ITEM!=null){
            var re= new MyVanillaItem(AddGroups.TOOLS_FUNCTIONAL, AddItem.MACE_ITEM,"LOGITECH_MACE_RECIPE",BukkitUtils.VANILLA_CRAFTTABLE,
                    recipe(AddItem.METAL_CORE,AddItem.BUG,AddItem.METAL_CORE,
                            null,AddItem.STAR_GOLD_INGOT,null,
                            null,AddItem.STAR_GOLD_INGOT,null));
            //todo we will add this to AddGroups.TOOLS_FUNCTIONAL later after we reconstruct AddGroups.TOOLS_FUNCTIONAL!
            return re.register();
        }
        return null;
    }).v();
    public static final SlimefunItem UNBREAKING_SHIELD=new MaterialItem(AddGroups.TOOLS_FUNCTIONAL,AddItem.UNBREAKING_SHIELD,BukkitUtils.VANILLA_CRAFTTABLE,
            recipe("IRON_BLOCK","DAMASCUS_STEEL_INGOT","IRON_BLOCK","IRON_BLOCK","OBSIDIAN","IRON_BLOCK",
            null,"IRON_BLOCK",null)).register();
    public static final MyVanillaItem SUPER_COBALT_PICKAXE = new MyVanillaItem(AddGroups.TOOLS_FUNCTIONAL,AddItem.SUPER_COBALT_PICKAXE,"SUPER_COBALT_PICKAXE", SmithInterfaceProcessor.INTERFACED_SMITH_UPDATE,recipe(AddItem.ABSTRACT_INGOT,"COBALT_PICKAXE","3DIAMOND",null,null,null,null,null,null))
            .register();
...
//            )
    ...
    public static final  SlimefunItem ITEM_OP=new ItemOperator(AddGroups.TOOLS_FUNCTIONAL, AddItem.ITEM_OP,RecipeType.ENHANCED_CRAFTING_TABLE,
    ...
    public static final SlimefunItem BNOISE_HEAD = new BNoiseHead(AddGroups.VANILLA, AddItem.BNOISE_HEAD, RecipeType.NULL,
            AddUtils.formatInfoRecipe(AddItem.BNOISE_MAKER,Language.get("Generators.BNOISE_MAKER.Name"))
            ).register();
...
//TODO add descriptions to these shits
    ...
    public static final SlimefunItem RECIPE_LOGGER=new RegisteryLogger(AddGroups.SPECIAL,AddItem.RECIPE_LOGGER,RecipeType.ENHANCED_CRAFTING_TABLE,
            ...
            .register();
    public static final SlimefunItem LASER_GUN= new LaserGun(AddGroups.TOOLS_FUNCTIONAL, AddItem.LASER_GUN, SmithInterfaceProcessor.INTERFACED_CRAFTTABLE,
            ...
            .register();
    public static final SlimefunItem TRACE_ARROW=new TrackingArrowLauncher(AddGroups.TOOLS_FUNCTIONAL,AddItem.TRACE_ARROW,SmithInterfaceProcessor.INTERFACED_CRAFTTABLE,
    ...
    public static final SlimefunItem FINAL_STACKMGENERATOR=new FinalStackMGenerator(AddGroups.BEYOND, AddItem.FINAL_STACKMGENERATOR,RecipeType.NULL,
            ...
            16)
            .register();
    public static final  SlimefunItem FINAL_CRAFT=new SpecialCrafter(AddGroups.BEYOND, AddItem.FINAL_CRAFT,STARSMELTERY,
    ...
    public static final  SlimefunItem SMITH_WORKSHOP=new SmithingWorkshop(AddGroups.TOOLS_FUNCTIONAL, AddItem.SMITH_WORKSHOP,COMMON_TYPE,
            ...
            .register();
    public static final  SlimefunItem SMITH_INTERFACE_NONE=new SmithingInterface(AddGroups.TOOLS_FUNCTIONAL, AddItem.SMITH_INTERFACE_NONE,RecipeType.ENHANCED_CRAFTING_TABLE,
            ...
            .register();
    public static final  SlimefunItem SMITH_INTERFACE_CRAFT=new SmithInterfaceProcessor(AddGroups.TOOLS_FUNCTIONAL, AddItem.SMITH_INTERFACE_CRAFT,RecipeType.ENHANCED_CRAFTING_TABLE,
    ...
    public static final  SlimefunItem ATTR_OP=new AttributeOperator(AddGroups.TOOLS_FUNCTIONAL, AddItem.ATTR_OP,RecipeType.MAGIC_WORKBENCH,
            ...
            .register();
    public static final SlimefunItem FU_BASE=new MaterialItem(AddGroups.TOOLS_FUNCTIONAL,AddItem.FU_BASE,RecipeType.ENHANCED_CRAFTING_TABLE,
            recipe(AddItem.ABSTRACT_INGOT,AddItem.LPLATE,AddItem.ABSTRACT_INGOT,AddItem.LPLATE,AddItem.TECH_CORE,AddItem.LPLATE,
                    AddItem.ABSTRACT_INGOT,AddItem.LPLATE,AddItem.ABSTRACT_INGOT),Utils.list(
                            AddUtils.getInfoShow("&f介绍","&7用于合成子分类\"功能单元\"中的物品","&7功能单元是一种&e类似附魔的组件型物品","&7安装在装备上可以给玩家带来增益")
    ))
            .register();
    public static final SlimefunItem AMPLIFY_BASE=new MaterialItem(AddGroups.TOOLS_SUBGROUP_1,AddItem.AMPLIFY_BASE,RecipeType.ENHANCED_CRAFTING_TABLE,
    ...
    public static final SWAmplifyComponent SWAMP_SPEED=(SWAmplifyComponent)new SWAmplifyComponent(AddGroups.TOOLS_SUBGROUP_1,AddItem.SWAMP_SPEED,SmithInterfaceProcessor.INTERFACED_CRAFTTABLE,
            ...
            .register();
    public static final SWAmplifyComponent SWAMP_RANGE=(SWAmplifyComponent)new SWAmplifyComponent(AddGroups.TOOLS_SUBGROUP_1,AddItem.SWAMP_RANGE,SmithInterfaceProcessor.INTERFACED_CRAFTTABLE,
            ...
            .register();
    public static final SlimefunItem DISPLAY_FU_USE=new DisplayUseTrimmerLogicLate(AddGroups.TOOLS_SUBGROUP_2,AddItem.DISPLAY_FU_USE,
            ...
            .register();
    public static final SlimefunItem DISPLAY_REMOVE_FU=new MaterialItem(AddGroups.TOOLS_SUBGROUP_2,AddItem.DISPLAY_REMOVE_FU,SmithInterfaceProcessor.INTERFACED_GRIND,
