...
public class NetworksQuantumProxyAdapter extends NetworksQuantumStorageAdapter implements LocationProxy {
    ...
    public static final SlimefunItem INSTANCE = SlimefunItem.getById("NTW_QUANTUM_STORAGE_1");
    ...
    public void disableNetworkQuantum(Throwable e) {
        Debug.logger("AN ERROR OCCURED IN NETWORK_QUANTUM_PROXY,STORAGE TYPE MAY BE DISABLED %d/%d"
