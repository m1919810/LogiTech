...
public abstract class MultiBlockAdvancedProcessor extends AbstractAdvancedProcessor
        implements MachineProcessHolder<MultiCraftingOperation>, MultiBlockCore {
    ...
    public MultiBlockAdvancedProcessor(
            ItemGroup itemGroup,
