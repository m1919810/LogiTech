...
public class QuarSorter extends AbstractSorter {
    ...
    protected int[] BORDER =
            new int[] {1, 3, 4, 5, 7, 10, 12, 14, 16, 18, 19, 20, 21, 23, 24, 25, 26, 28, 30, 32, 34, 37, 39, 40, 41, 43
            };
    protected int[] INPUT_SLOT = new int[] {11, 29, 33, 15};
    protected int[] INPUTW_SLOT = new int[] {9, 27, 35, 17};
    protected int[] OUTPUT_SLOT = new int[] {31};
    protected int[] INFO_SLOT = new int[] {0, 2, 6, 8, 36, 38, 42, 44};
