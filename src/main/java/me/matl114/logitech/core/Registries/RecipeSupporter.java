...
public class RecipeSupporter {
    ...
    private static final ArrayList<MachineRecipe> GOLDPAN_RECIPE = new ArrayList<>() {
        {
            add(MachineRecipeUtils.stackFrom(-1, new ItemStack[] {new ItemStack(Material.GRAVEL)}, new ItemStack[] {
                AddUtils.randItemStackFactory(new ArrayList<>() {
                    {
    ...
    private static final ArrayList<MachineRecipe> ORE_WASHER_RECIPE = new ArrayList<>() {
        {
            add(MachineRecipeUtils.stackFrom(-1, new ItemStack[] {SlimefunItems.SIFTED_ORE}, new ItemStack[] {
            ...
            add(MachineRecipeUtils.stackFrom(
                    -1, new ItemStack[] {SlimefunItems.PULVERIZED_ORE}, new ItemStack[] {SlimefunItems.PURE_ORE_CLUSTER
                    }));
            add(MachineRecipeUtils.stackFrom(
                    -1, new ItemStack[] {new ItemStack(Material.SAND, 2)}, new ItemStack[] {SlimefunItems.SALT}));
        }
    };
    private static final ArrayList<MachineRecipe> TABLE_SAW_RECIPE = new ArrayList<>() {
        {
            for (Material log : Tag.LOGS.getValues()) {
                ...
                if (planks.isPresent()) {
                    ...
                    add(MachineRecipeUtils.stackFrom(
                            -1, Utils.array(new ItemStack(log)), Utils.array(new ItemStack(planks.get(), 8))));
                }
            }

            for (Material plank : Tag.PLANKS.getValues()) {
                add(MachineRecipeUtils.stackFrom(
                        -1, Utils.array(new ItemStack(plank)), Utils.array(new ItemStack(Material.STICK, 4))));
            }
        }
    };
    ...
    public static final List<MachineRecipe> UNUSTACKABLE_ITEM_RECIPES = new ArrayList<>() {
        {
            ...
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.WATER_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(null, "BUCKET", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.LAVA_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(null, null, "BUCKET", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MILK_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(null, null, null, "BUCKET", null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.POWDER_SNOW_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", "BUCKET", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.COD_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, "BUCKET", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.SALMON_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, null, "BUCKET", null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.TROPICAL_FISH_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, null, null, "BUCKET", null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.PUFFERFISH_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, null, null, null, "BUCKET", null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.AXOLOTL_BUCKET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("BUCKET", null, null, null, null, null, "BUCKET", null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.TADPOLE_BUCKET))));
            ...
            add(MachineRecipeUtils.shapeFrom(
                    ...
                    Utils.recipe(
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_SWORD))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_SHOVEL))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_PICKAXE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_AXE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_HOE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_HELMET))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_CHESTPLATE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_LEGGINGS))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe(
                            "NETHERITE_INGOT",
                            ...
                            null,
                            null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.NETHERITE_BOOTS))));

            // 唱片
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_13", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_13))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_CAT", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_CAT))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_BLOCKS", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_BLOCKS))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_CHIRP", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_CHIRP))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_FAR", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_FAR))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_MALL", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_MALL))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_MELLOHI", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_MELLOHI))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_STAL", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_STAL))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_STRAD", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_STRAD))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_WARD", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_WARD))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_11", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_11))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_WAIT", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_WAIT))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_PIGSTEP", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_PIGSTEP))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_OTHERSIDE", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_OTHERSIDE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("MUSIC_DISC_RELIC", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MUSIC_DISC_RELIC))));

            // 旗帜图案

            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("GLOBE_BANNER_PATTERN", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.GLOBE_BANNER_PATTERN))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("PIGLIN_BANNER_PATTERN", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.PIGLIN_BANNER_PATTERN))));

            // 潜影盒

            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "WHITE_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.WHITE_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "ORANGE_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.ORANGE_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "MAGENTA_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.MAGENTA_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "LIGHT_BLUE_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.LIGHT_BLUE_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "YELLOW_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.YELLOW_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "LIME_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.LIME_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "PINK_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.PINK_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "GRAY_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.GRAY_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "LIGHT_GRAY_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.LIGHT_GRAY_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "CYAN_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.CYAN_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "PURPLE_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.PURPLE_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "BLUE_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.BLUE_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "BROWN_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.BROWN_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "GREEN_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.GREEN_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "RED_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.RED_SHULKER_BOX))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SHULKER_BOX", "BLACK_DYE", null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.BLACK_SHULKER_BOX))));

            // 其它装备
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("TRIDENT", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.TRIDENT))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("TOTEM_OF_UNDYING", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.TOTEM_OF_UNDYING))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("IRON_HORSE_ARMOR", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.IRON_HORSE_ARMOR))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("GOLDEN_HORSE_ARMOR", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.GOLDEN_HORSE_ARMOR))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("DIAMOND_HORSE_ARMOR", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.DIAMOND_HORSE_ARMOR))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("ELYTRA", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.ELYTRA))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SADDLE", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.SADDLE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("ENCHANTED_BOOK", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.ENCHANTED_BOOK))));

            // 杂类

            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SNOWBALL", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.SNOWBALL))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("EGG", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.EGG))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("ENDER_PEARL", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.ENDER_PEARL))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("WRITTEN_BOOK", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.WRITTEN_BOOK))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("HONEY_BOTTLE", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.HONEY_BOTTLE))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("DEBUG_STICK", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.DEBUG_STICK))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("COMMAND_BLOCK_MINECART", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.COMMAND_BLOCK_MINECART))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("KNOWLEDGE_BOOK", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.KNOWLEDGE_BOOK))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("GOAT_HORN", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.GOAT_HORN))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("POTION", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.POTION))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("SPLASH_POTION", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.SPLASH_POTION))));
            add(MachineRecipeUtils.shapeFrom(
                    -1,
                    Utils.recipe("LINGERING_POTION", null, null, null, null, null, null, null),
                    Utils.recipe(AddSlimefunItems.REPLACE_CARD.getReplaceCard(Material.LINGERING_POTION))));
        }
    };
    // 注册为可识别icon的
    ...
    public static boolean tryModifyStandardMachineRecipe(
            SlimefunItem item, List<MachineRecipe> sourceRecipe, boolean append) {
    ...
    public static void loadMachineModification(Config config, String root, boolean withWarning) {
        if (MyAddon.testmode()) withWarning = true;
                    ...
                    find_possible_recipe:
                    {
                        ...
                        if (type != null) {
                            try {
                                ...
                                if (withWarning) {
                                    Debug.logger("ERROR WHILE LOADING RECIPETYPE RECIPE LIST: RecipeType %s"
                                            .formatted(recipeType));
                                }
                            }
                        ...
                        if (item != null) {
                            try {
                                List<MachineRecipe> rplist = item instanceof MultiBlockMachine mb
                                ...
                                if (withWarning) {
                                    Debug.logger("ERROR WHILE LOADING MACHINE RECIPE LIST: RecipeType %s"
                                            .formatted(recipeType));
                                }
                            }
                            break find_possible_recipe;
                        ...
                        if (withWarning)
                            Debug.logger("ERROR WHILE LOADING MACHINE CONFIG: RecipeType %s not found"
                                    .formatted(recipeType));
                    }
                } catch (Throwable e) {
                }
        ...
        try {
            ...
            if (stack.isEmpty()) {
                throw new IllegalArgumentException(
                        "illegal config format %s".formatted(AddUtils.concat(itemPath, ".")));
            }
    ...
    public static MachineRecipe transferRSCRecipes(MachineRecipe rsc) {
        ...
        try {
            ...
            Debug.debug("generate an exception while transfer rsc recipes %s"
                    .formatted(rsc.getClass().getName()));
            if (MyAddon.testmode()) e.printStackTrace();
            return null;
        }
    }
    ...
    public static void initRecipeSupportor() {
            ...
            if (next instanceof ShapedRecipe sr) {
                ...
                for (int i = 0; i < len1; ++i) {
                    ...
                    for (int j = 0; j < len3; ++j) {
                        ...
                        if (rc == null) {
                            ...
                            Debug.logger(
                                    "Unknown RecipeChoice class", rc.getClass().getName());
                        }
                    }
                }

                PROVIDED_SHAPED_RECIPES
                        .get(BukkitUtils.VANILLA_CRAFTTABLE)
                        .add(MachineRecipeUtils.shapeFrom(-1, inputs, Utils.array(next.getResult())));
                PROVIDED_UNSHAPED_RECIPES
                        .get(BukkitUtils.VANILLA_CRAFTTABLE)
                        .add(MachineRecipeUtils.stackFrom(-1, inputs, Utils.array(next.getResult())));
                ...
                if (choice instanceof RecipeChoice.MaterialChoice materialChoice) {
                    for (Material input : materialChoice.getChoices()) {
                        PROVIDED_UNSHAPED_RECIPES
                                .get(BukkitUtils.VANILLA_FURNACE)
                                .add(MachineRecipeUtils.stackFrom(
        ...
        for (SlimefunItem item : Slimefun.getRegistry().getEnabledSlimefunItems()) {
            ...
            RECIPETYPE_TO_ITEMS
                    .computeIfAbsent(recipeType, t -> new ArrayList<>())
                    .add(item);
            // 过会解析
        ...
        for (RecipeType recipeType : RECIPE_TYPES) {
            if (!BLACKLIST_RECIPETYPES.contains(recipeType)) { // not in black list
                if (recipeType instanceof CustomRecipeType crp) {
                    ...
                    PROVIDED_SHAPED_RECIPES
                            .computeIfAbsent(recipeType, k -> new ArrayList<>())
        ...
        for (SlimefunItem item : Slimefun.getRegistry().getEnabledSlimefunItems()) {
            ...
            if ((!BLACKLIST_RECIPETYPES.contains(recipeType))
                    && (!MULTIBLOCK_RECIPETYPES.containsKey(recipeType))
                    && !(recipeType instanceof CustomRecipeType)) {
            ...
            if (recipeType == RecipeType.MULTIBLOCK) {
                if (item instanceof MultiBlockMachine) {
                    if (!BLACKLIST_MULTIBLOCK.contains(item) && (!MULTIBLOCK_RECIPES.containsKey(item))) {
                        ...
                        List<MachineRecipe> recipes = new ArrayList<>();
                        for (ItemStack[] recipeInput : recipeInputs) {
                            recipes.add(MachineRecipeUtils.stackFrom(0, recipeInput, new ItemStack[] {
                                RecipeType.getRecipeOutputList((MultiBlockMachine) item, recipeInput)
                            }));
                        }
        ...
        HashMap<EntityType, ItemStack[]> preData = new HashMap<>() {
            {
                ...
                put(
                        ...
                        Utils.recipe(
                                "ROTTEN_FLESH",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("IRON_INGOT"), 2),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("CARROT"), 2),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("POTATO"), 2)));
                put(
                ...
                put(
                        ...
                        Utils.recipe(
                                "ROTTEN_FLESH",
                                "GOLD_NUGGET",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("GOLD_INGOT"), 2),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("GOLDEN_SWORD"), 2)));
                put(EntityType.PIGLIN, Utils.recipe("ARROW", "GOLD_INGOT"));
                put(
                        EntityType.PIGLIN_BRUTE,
                        Utils.recipe(
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("GOLDEN_AXE"), 8), "GOLD_INGOT"));
                put(
                        EntityType.DROWNED,
                        Utils.recipe(
                                "ROTTEN_FLESH",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("COPPER_INGOT"), 11),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("NAUTILUS_SHELL"), 20),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("TRIDENT"), 2)));
                put(
                        EntityType.ELDER_GUARDIAN,
                        Utils.recipe(
                                "PRISMARINE_SHARD",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("PRISMARINE_CRYSTALS"), 33),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("COD"), 50),
                                "WET_SPONGE"));
                put(
                        EntityType.GUARDIAN,
                        Utils.recipe(
                                "PRISMARINE_SHARD",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("PRISMARINE_CRYSTALS"), 40),
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("COD"), 40)));
                ...
                put(
                        ...
                        Utils.recipe(
                                "BONE",
                                "COAL",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("WITHER_SKELETON_SKULL"), 2)));
                put(
                        EntityType.CREEPER,
                        Utils.recipe(
                                "GUNPOWDER", AddUtils.probItemStackFactory(AddUtils.resolveItem("CREEPER_HEAD"), 5)));
                put(EntityType.SPIDER, Utils.recipe("STRING", "SPIDER_EYE"));
                put(EntityType.CAVE_SPIDER, Utils.recipe("STRING", "SPIDER_EYE"));
                put(
                        EntityType.ENDERMAN,
                        Utils.recipe(
                                "ENDER_PEARL", AddUtils.probItemStackFactory(AddUtils.resolveItem("ENDER_EYE"), 25)));
                put(EntityType.GHAST, Utils.recipe("GHAST_TEAR", "GUNPOWDER"));
                put(
                        EntityType.EVOKER,
                        Utils.recipe(
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("TOTEM_OF_UNDYING"), 25),
                                "EMERALD"));
                ...
                put(
                        EntityType.WITCH,
                        Utils.recipe(AddUtils.eqRandItemStackFactory(Arrays.stream(Utils.recipe(
                                        "REDSTONE", "GLASS_BOTTLE", "GUNPOWDER", "SPIDER_EYE", "STICK", "SUGAR"))
                                .toList())));
                ...
                put(
                        ...
                        Utils.recipe(
                                "DRAGON_BREATH",
                                AddUtils.probItemStackFactory(new ItemStack(Material.DRAGON_HEAD), 5),
                ...
                put(
                        ...
                        Utils.recipe(
                                "BEEF",
                                "LEATHER",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("RED_MUSHROOM"), 25)));
                put(EntityType.CAT, Utils.recipe("STRING"));
                put(EntityType.CHICKEN, Utils.recipe("CHICKEN", "FEATHER"));
                put(
                        EntityType.COD,
                        Utils.recipe("COD", AddUtils.probItemStackFactory(AddUtils.resolveItem("BONE_MEAL"), 5)));
                put(EntityType.DOLPHIN, Utils.recipe("COD"));
                put(EntityType.SHEEP, Utils.recipe("WHITE_WOOL", "MUTTON"));
                put(
                        EntityType.HORSE,
                        Utils.recipe("LEATHER", AddUtils.probItemStackFactory(AddUtils.resolveItem("SADDLE"), 5)));
                put(
                        EntityType.DONKEY,
                        Utils.recipe("LEATHER", AddUtils.probItemStackFactory(AddUtils.resolveItem("SADDLE"), 5)));
                put(
                ...
                put(
                        EntityType.PANDA,
                        Utils.recipe("BAMBOO", AddUtils.probItemStackFactory(AddUtils.resolveItem("SLIME_BALL"), 1)));
                put(EntityType.PARROT, Utils.recipe("FEATHER"));
                put(EntityType.POLAR_BEAR, Utils.recipe("COD", "SALMON"));
                put(
                        EntityType.PUFFERFISH,
                        Utils.recipe(
                                "PUFFERFISH", AddUtils.probItemStackFactory(AddUtils.resolveItem("BONE_MEAL"), 5)));
                put(
                        EntityType.RABBIT,
                        Utils.recipe(
                                "RABBIT",
                                "RABBIT_HIDE",
                                AddUtils.probItemStackFactory(AddUtils.resolveItem("RABBIT_FOOT"), 10)));
                put(
                        EntityType.SALMON,
                ...
                put(
                        ...
                        Utils.recipe(
                                "TROPICAL_FISH", AddUtils.probItemStackFactory(AddUtils.resolveItem("BONE_MEAL"), 5)));
                put(
                        EntityType.TURTLE,
                        Utils.recipe(
        ...
        for (RecipeType type : RECIPE_TYPES) {
            try {
                ...
                if (it != null) {
                    SlimefunItemStack sfit =
                            new SlimefunItemStack(id + "_ICON", AddUtils.addLore(it, "", "&7配方类型:" + ns + ":" + id));
        ...
        for (SlimefunItem item : Slimefun.getRegistry().getEnabledSlimefunItems()) {
            try {
                ...
                ReflectUtils.isExtendedFrom(item.getClass(), ".CustomMaterialGenerator")) {
                    ...
                    //                    //item instanceof
                    // CustomMaterialGenerator){//org.lins.mmmjjkx.rykenslimefuncustomizer.objects.customs.machine.CustomMaterialGenerator){
                    String methodName = null;
                    if (methodName == null) {
                        try {
                            ...
                            try {
                                chance = (List<Integer>)
                                        ReflectUtils.invokeGetRecursively(item, Settings.FIELD, "chances");
                            } catch (Throwable e) {
                            ...
                            try {
                                chooseOne =
                                        (Boolean) ReflectUtils.invokeGetRecursively(item, Settings.FIELD, "chooseOne");
                                if (chooseOne) {
                                    outputList = new ItemStack[] {
                                        AddUtils.eqRandItemStackFactory(
                                                Arrays.stream(outputList).toList())
                                    };
                                }
                            } catch (Throwable e) {
                    ...
                    if (methodName == null) {
                        try {
                            ...
                            if (stack instanceof List stacklist) {
                                ...
                                recipes.add(MachineRecipeUtils.mgFrom(
                                        (Integer) tick, new ItemStack[0], new ItemStack[] {(ItemStack) stack}));
                            }
                    ...
                    if (!blst) {
                        ...
                        switch (1) {
                            case 1:
                                ...
                                try {
                                    if (methodName == null) {
                                        machineRecipes = ReflectUtils.invokeGetRecursively(
                                                item, Settings.METHOD, "getMachineRecipes");
                                        if (machineRecipes != null) {
                                    ...
                                    if (methodName == null) {
                                        machineRecipes =
                                                ReflectUtils.invokeGetRecursively(item, Settings.FIELD, "recipes");
                                        if (machineRecipes != null) {
                                    ...
                                    if (methodName == null) {
                                        machineRecipes = ReflectUtils.invokeGetRecursively(
                                                item, Settings.FIELD, "machineRecipes");
                                        if (machineRecipes != null) {
                                    ...
                                    if (machineRecipes != null) {
                                        if (machineRecipes instanceof List) {
                                            for (Object machineRecipe : (List) machineRecipes) {
                                                ...
                                                if (machineRecipe instanceof MachineRecipe) {
                                                ...
                                                } else if (machineRecipe
                                                        instanceof ItemStack) { // some of sf's shit machine
                                                    if (item instanceof Composter) {
                                                        int len = ((List<?>) machineRecipes).size();
                                                        for (int i = 0; i < len; i += 2) {
                                                            recipes.add(MachineRecipeUtils.stackFrom(
                                                                    4,
                                                                    new ItemStack[] {
                                                                        (ItemStack) ((List<?>) machineRecipes).get(i)
                                                                    },
                                                                    new ItemStack[] {
                                                                        (ItemStack)
                                                                                ((List<?>) machineRecipes).get(i + 1)
                                                                    }));
                                                        }
                                                        break;
                                                    ...
                                                    if (!inp.isEmpty()) inpCopy.addAll(inp);
                                                    inpCopy.add(4, (ar).getCatalyst());
                                                    MachineRecipe rp = new MachineRecipe(
                                                            9,
                                                            inpCopy.toArray(new ItemStack[inpCopy.size()]),
                                                            new ItemStack[] {((AltarRecipe) machineRecipe).getOutput()
                                                            });
                                                    recipes.add(rp);
                                                } else if (machineRecipe
                                                                .getClass()
                                                                .getName()
                                                                .endsWith(infinityMachineBlockRecipe)
                                                        && machineRecipe
                                                                .getClass()
                                                                .getName()
                                                                .contains(infinitylib)) {
                                                    MachineRecipe ip =
                                                            resolveInfinityMachineBlockRecipe(machineRecipe, item);
                                                    if (ip != null) {
                                                    ...
                                                    throw new ClassCastException(
                                                            "wrong " + methodName + " return type , " + "List of "
                                                                    + machineRecipe
                                                                            .getClass()
                                                                            .getName());
                                                }
    ...
    public static boolean resolveSpecialGenerators(SlimefunItem item, List<MachineRecipe> recipes) {
        ...
        if (ReflectUtils.isExtendedFrom(item.getClass(), "GrowingMachine")) {
            ...
            try {
                EnumMap<Material, ItemStack[]> map = (EnumMap<Material, ItemStack[]>)
                        ReflectUtils.invokeGetRecursively(item, Settings.FIELD, "recipes");
                for (Map.Entry<Material, ItemStack[]> entry : map.entrySet()) {
                    recipes.add(MachineRecipeUtils.mgFrom(
                            ticks, Utils.array(new ItemStack(entry.getKey())), entry.getValue()));
                }
            } catch (Throwable e) {
            ...
            try {
                ...
                recipes.add(
                        MachineRecipeUtils.mgFrom(ticks, Utils.array(), Utils.array(new ItemStack(material, amount))));
            } catch (Throwable e) {
                Debug.logger("Error in loading Slimefun Item %s StackMachineRecipe: %s"
                        .formatted(item.getId(), e.getMessage()));
                return false;
            ...
            try {
                Class supremeClass =
                        item.getAddon().getClass(); // Class.forName("com.github.relativobr.supreme.Supreme");
                Object obj =
                        ReflectUtils.invokeGetRecursively(null, supremeClass, Settings.METHOD, "getSupremeOptions");
            ...
            Class OscillatorClass =
                    SlimefunItem.getById("QUARRY_OSCILLATOR_DIAMOND").getClass();
            try {
                HashMap OSCILLATORS_MAP = (HashMap)
                        ReflectUtils.invokeGetRecursively(null, OscillatorClass, Settings.FIELD, "OSCILLATORS");
                Material[] outputlist = (Material[]) ReflectUtils.invokeGetRecursively(item, Settings.FIELD, "outputs");
                List<ItemStack> outputItemlist = Arrays.stream(outputlist)
                        .map((material -> new ItemStack(material, amount)))
                        .toList();
                ItemStack outputRandGroup = AddUtils.eqRandItemStackFactory(outputItemlist);
                recipes.add(MachineRecipeUtils.mgFrom(
                        ticks, new ItemStack[] {new ItemStack(Material.COBBLESTONE)}, new ItemStack[] {outputRandGroup
                        }));
                for (Object e : OSCILLATORS_MAP.values()) {
                    try {
                        SlimefunItem oscillatorsInstance = (SlimefunItem) e;
                        double chance = (Double)
                                ReflectUtils.invokeGetRecursively(oscillatorsInstance, Settings.FIELD, "chance");
                        ItemStack oscillatorsType =
                                new ItemStack(oscillatorsInstance.getItem().getType(), amount);
                        ...
                        recipes.add(MachineRecipeUtils.mgFrom(
                                ticks, new ItemStack[] {oscillatorsInstance.getItem()}, new ItemStack[] {randOut}));
                    } catch (Throwable E) {
                        if (e instanceof SlimefunItem sf) {
                            Debug.logger("Error in loading QUARRY_OSCILLATORS Item %s : %s"
                                    .formatted(sf.getId(), E.getMessage()));
                        } else {
        ...
        if (machineRecipes.isEmpty() || craftType != null) {
            if (craftType.length <= 0) {
                ...
                for (RecipeType rt : craftType) {
                    if (rt != null) machineRecipes.addAll(RecipeSupporter.getStackedRecipes(rt));
                }
            }
            if (machineRecipes == null) {
                machineRecipes = new ArrayList<>();
