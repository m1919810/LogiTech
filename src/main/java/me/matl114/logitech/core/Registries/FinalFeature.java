...
public class FinalFeature {
    ...
    public static final ItemPusherProvider STORAGE_AND_LOCPROXY_READER = new ItemPusherProvider() {
        ...
        @Override
        public IntFunction<ItemPusher> getMenu(
                Settings settings, BlockMenu inv, IntFunction<ItemStack> stackFunction, int[] slots) {
    ...
    public static final ItemStack MANUAL_CARD_INFO = AddUtils.addGlow(new CleanItemStack(
    ...
    // actually ,about location proxy, machines should run in order AT ANY TIME,otherwise it will cause negative
    // itemStorage
