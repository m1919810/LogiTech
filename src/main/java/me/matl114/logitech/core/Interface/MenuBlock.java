...
public interface MenuBlock extends InventoryBlock {
        ...
        machine.addItemHandler(
                new BlockBreakHandler(false, false) {
                    ...
                    public void onPlayerBreak(BlockBreakEvent e, ItemStack itemStack, List<ItemStack> list) {
                        BlockMenu menu = DataCache.getMenu(
                                e.getBlock().getLocation()); // BlockStorage.getInventory(e.getBlock());
    ...
    public abstract static class AdvancedBlockMenuPreset extends BlockMenuPreset {
        // 双击 拖拽都无法监听！
        boolean doubleClick;
        MenuBlock instance;
