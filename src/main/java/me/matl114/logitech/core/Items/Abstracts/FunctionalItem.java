...
public class FunctionalItem extends DistinctiveCustomSlimefunItem {
    ...
    public boolean canStack(@NotNull ItemMeta var1, @NotNull ItemMeta var2) {
        ...
        return var1.getPersistentDataContainer().equals(var2.getPersistentDataContainer())
                && CraftUtils.matchLoreField(var1, var2)
                && CraftUtils.matchEnchantmentsFields(var1, var2)
                && me.matl114.logitech.utils.CraftUtils.matchAttrbuteField(var1, var2);
    }
}
