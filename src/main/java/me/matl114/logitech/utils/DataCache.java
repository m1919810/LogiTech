...
public class DataCache {
    ...
    private static final ChunkDataLoadMode CHUNK_MODE =
            Slimefun.getDatabaseManager().getChunkDataLoadMode();
    ...
    public static void setLastLocation(SlimefunBlockData data, Location loc) {
        setLocation("location", data, loc);
    }
    ...
    public static void runAfterSafeLoad(SlimefunBlockData data, Consumer<SlimefunBlockData> consumer, boolean isSync) {
