...
public class AddUtils {
    ...
    public static final ItemStack[] NULL_RECIPE =
    ...
    public enum Theme {
        ...
        ITEM1(AddUtils::color, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        ITEM2(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        MACHINE1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        MACHINE2(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        MULTIBLOCK1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        MULTIBLOCK2(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        MANUAL1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        ADVANCED1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        CARGO1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
        ...
        BENCH1(AddUtils::colorful, ((List<String> a) -> {
            {
                List<String> finallist = new ArrayList<>();
                for (String i : a) {
                    finallist.add(desc(i));
    ...
    public static SlimefunItemStack themed(
            String id, Material itemStack, Theme themeType, String name, String... lore) {
    ...
    public static SlimefunItemStack themed(
            String id, Material itemStack, Theme themeType, String name, List<String> lore) {
        return themed(id, new ItemStack(itemStack), themeType, name, lore);
    }

    public static SlimefunItemStack themed(
            String id, ItemStack itemStack, Theme themeType, String name, List<String> lore) {
        List<String> finallist = themeType.LORE_DEC.decorator(lore);
        return new SlimefunItemStack(
                idDecorator(id), itemStack, themeType.NAME_DEC.decorate(name), finallist.toArray(String[]::new));
    }
    ...
    public static ItemStack themed(ItemStack itemStack, Theme themeType, String name, List<String> lore) {
        List<String> finallist = themeType.LORE_DEC.decorator(lore);
        return new CustomItemStack(itemStack, themeType.NAME_DEC.decorate(name), finallist.toArray(String[]::new));
    }
        ...
        if (stack.getClass().getName().endsWith("RandomizedItemStack")) {
            try {
                ...
                if (itemlist != null) {
                    ...
                    result =
                            AddUtils.eqRandItemStackFactory(Arrays.stream(list1).toList());
                } else if ((itemlist = ReflectUtils.invokeGetRecursively(stack, Settings.FIELD, "itemStacks"))
                        != null) {
                    ItemStack[] list1 = (ItemStack[]) itemlist;
                    result =
                            AddUtils.eqRandItemStackFactory(Arrays.stream(list1).toList());
    ...
    public static <T extends Object> List<Pair<Pair<ItemStack[], ItemStack[]>, Integer>> buildRecipeMap(
        ...
        rawDataMap.forEach((p) -> {
            ...
            if (k instanceof Object[]) {
                ...
                map.add(new Pair<>(
                        AddUtils.buildRecipes(
                                Arrays.copyOfRange((Object[]) k, 0, 2), Arrays.copyOfRange((Object[]) k, 2, 4)),
                        v));
    ...
    public static ItemStack workBenchInfoAdd(ItemStack item, int energyBuffer, int energyConsumption) {
        return AddUtils.addLore(
                item, LoreBuilder.powerBuffer(energyBuffer), AddUtils.energyPerCraft(energyConsumption));
    }
    ...
    public static ItemStack machineInfoAdd(ItemStack item, int energyBuffer, int energyConsumption, Settings type) {
        if (type == Settings.USE_SEC_EXP) {
            return AddUtils.addLore(
                    item, LoreBuilder.powerBuffer(energyBuffer), AddUtils.energyPerSecond(energyConsumption));
        } else if (type == Settings.USE_TICK_EXP) {
            return AddUtils.addLore(
                    item, LoreBuilder.powerBuffer(energyBuffer), AddUtils.energyPerTick(energyConsumption));
        } else return null;
    }
    ...
    public static ItemStack[] formatInfoRecipe(ItemStack stack, String source) {
        return new ItemStack[] {
            null, stack, null, null, getInfoShow("&f获取方式", "&7在 %s 中获取".formatted(source)), null, null, null, null
        };
    }

    public static MachineRecipe formatInfoMachineRecipe(ItemStack[] stack, int tick, String... description) {
        return MachineRecipeUtils.From(tick, new ItemStack[] {getInfoShow("&f获取方式", description)}, stack);
    }
