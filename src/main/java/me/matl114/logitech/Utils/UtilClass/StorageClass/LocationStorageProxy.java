...
//
//            //TODO 很根本的解决方案 在一个进程中保证链接单个location的唯一性
//
...
//        }
//    }
    public static LocationStorageProxy createProxy(Location loc,ItemStorageCache cache,LocationProxy type) {
          return new LocationStorageProxy(loc,cache,type);
    }

    private LocationStorageProxy(Location source, ItemStorageCache cache,LocationProxy type){
        super();
       this. handle = cache;
       this. source = source;
       this.type = type;
